        ...
        with tf.variable_scope(scope_name, reuse=reuse) as sc:
            ...
            with slim.arg_scope([slim.convolution2d, slim.separable_convolution2d],
                ...
                with slim.arg_scope([slim.batch_norm],
                    ...
                    net = _depthwise_separable_conv(net, 64, 'conv_ds_2')
                    net = _depthwise_separable_conv(net, 128, 'conv_ds_3', downsample=True)
                    self.conv_ds_3 = net
                    net = _depthwise_separable_conv(net, 128, 'conv_ds_4')
                    self.conv_ds_4 = net
                    net = _depthwise_separable_conv(net, 256, 'conv_ds_5', downsample=True)
                    self.conv_ds_5 = net
                    net = _depthwise_separable_conv(net, 256, 'conv_ds_6')
                    self.conv_ds_6 = net
                    net = _depthwise_separable_conv(net, 512, 'conv_ds_7', downsample=True)
                    self.conv_ds_7 = net

                    net = _depthwise_separable_conv(net, 512, 'conv_ds_8')
                    self.conv_ds_8 = net
                    net = _depthwise_separable_conv(net, 512, 'conv_ds_9')
                    self.conv_ds_9 = net
                    net = _depthwise_separable_conv(net, 512, 'conv_ds_10')
                    self.conv_ds_10 = net
                    net = _depthwise_separable_conv(net, 512, 'conv_ds_11')
                    self.conv_ds_11 = net
                    net = _depthwise_separable_conv(net, 512, 'conv_ds_12')
                    self.conv_ds_12 = net

                    net = _depthwise_separable_conv(net, 1024, 'conv_ds_13', downsample=True)
                    self.conv_ds_13 = net
                    net = _depthwise_separable_conv(net, 1024, 'conv_ds_14')
                    self.conv_ds_14 = net
